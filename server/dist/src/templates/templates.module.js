...
const templates_admin_controller_1 = require("./templates-admin.controller");
...
exports.TemplatesModule = TemplatesModule = __decorate([
    (0, common_1.Module)({
        imports: [],
        providers: [templates_service_1.TemplatesService, bearer_auth_guard_1.BearerAuthGuard],
        controllers: [templates_controller_1.TemplatesController, templates_admin_controller_1.TemplatesAdminController],
