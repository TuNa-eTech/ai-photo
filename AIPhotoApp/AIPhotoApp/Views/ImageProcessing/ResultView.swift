...
struct ResultView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .navigationBarBackButtonHidden(true)  // Hide back button, only show Done
            .toolbar {
                ToolbarItem(placement: .topBarTrailing) {
                    Button(L10n.tr("l10n.common.done")) {
                        // Call onDismiss to pop entire navigation stack to Home
                        onDismiss?()
                    }
                    .foregroundStyle(GlassTokens.textPrimary)
                }
