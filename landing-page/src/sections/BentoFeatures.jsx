        ...
        <section id="features" className="py-20 relative">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-4">{t('bentoFeatures.title')} <span className="text-gradient">{t('bentoFeatures.titleHighlight')}</span></h2>
                    <p className="text-gray-400">{t('bentoFeatures.subtitle')}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto auto-rows-[300px]">
                    ...
                    <GlassCard className="md:col-span-2 md:row-span-2 relative overflow-hidden group" hoverEffect={true}>
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            <div>
                                ...
                                <h3 className="text-2xl font-bold mb-2">{t('bentoFeatures.removeBackground.title')}</h3>
                                <p className="text-gray-400">{t('bentoFeatures.removeBackground.desc')}</p>
                            </div>
                    ...
                    <GlassCard className="relative overflow-hidden group" hoverEffect={true}>
                        <div className="relative z-10">
                            ...
                            <h3 className="text-xl font-bold mb-2">{t('bentoFeatures.upscale.title')}</h3>
                            <p className="text-sm text-gray-400">{t('bentoFeatures.upscale.desc')}</p>
                        </div>
                    ...
                    <GlassCard className="relative overflow-hidden group" hoverEffect={true}>
                        <div className="relative z-10">
                            ...
                            <h3 className="text-xl font-bold mb-2">{t('bentoFeatures.aiStyle.title')}</h3>
                            <p className="text-sm text-gray-400">{t('bentoFeatures.aiStyle.desc')}</p>
                        </div>
                    ...
                    <GlassCard className="md:col-span-3 relative overflow-hidden group" hoverEffect={true}>
                        <div className="flex flex-col md:flex-row items-center gap-8 h-full">
                            <div className="flex-1">
                                ...
                                <h3 className="text-2xl font-bold mb-2">{t('bentoFeatures.magicEraser.title')}</h3>
                                <p className="text-gray-400 max-w-md">{t('bentoFeatures.magicEraser.desc')}</p>
                            </div>
